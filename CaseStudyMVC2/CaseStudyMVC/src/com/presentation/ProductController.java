...
public class ProductController {
	...
	public String deleteProduct(@RequestParam("id") int Product_id,ModelMap map) throws SQLException{
		
		productService.delProductService(Product_id);
	...
	public String newCustomer(@PathVariable("id") int Product_id,ModelMap map) throws SQLException{
		System.out.println(Product_id);
		
		map.addAttribute("product", productService.searchProductService(Product_id));
		//map.addAttribute("product",productService.updateProductService(Product_id));
